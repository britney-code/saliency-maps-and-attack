...
class NAA:
    def __init__(self,
                 esp=16 / 255, steps=10, u=1, a=1.6 / 255, ens=30,
                 device=torch.device("cuda:0" if torch.cuda.is_available() else "cpu"), seed=1234,
        ...
        for i in range(self.steps):
            ...
            if i == 0:
                ...
                for l in range(self.ens):
                    ...
                    image_tmp = self.trans(inputs.clone()) + temp_noise
            ...
            logits = model(self.trans(base_line))
